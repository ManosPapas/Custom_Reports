...
class SqlFormatter extends Controller
{
    ...
    public static $word_attributes = 'style="color: green;"';
    ...
    public static $pre_attributes = 'style="color: yellow; background-color: black;"';
